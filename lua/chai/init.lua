...
function M.load()
  ...
  Group.new("CursorLineNr", colors.activeForground, colors.none, styles.NONE)
  ...
  Group.new("Strikethrough", colors.acrtiveBackground, colors.none, styles.NONE)
  ...
  Group.new("StatusLine", colors.lowBackground, colors.none, styles.bold)
  Group.new("StatusLineNC", colors.lowActiveBackground, colors.black, styles.reverse)
  Group.new("Visual", colors.none, colors.black, opts.reverse_visual and styles.reverse or styles.NONE)
